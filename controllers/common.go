...
func (r *VisitorAppReconciler) ensureDeployment(request reconcile.Request,
	instance *defaultv1alpha1.VisitorApp,
...
func (r *VisitorAppReconciler) ensureService(request reconcile.Request,
	instance *defaultv1alpha1.VisitorApp,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *VisitorAppReconciler) ensureSecret(request reconcile.Request,
	instance *defaultv1alpha1.VisitorApp,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func labels(v *defaultv1alpha1.VisitorApp, tier string) map[string]string {
